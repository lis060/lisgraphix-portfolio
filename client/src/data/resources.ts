...
export const resources: Resource[] = [
  {
    ...
    type: 'PDF',
    icon: 'FileCheck',
    href: '/downloads/website-launch-checklist.txt',
    filename: 'Lisgraphix-Website-Launch-Checklist.txt',
    tag: 'Free Download',
    pages: '3 pages',
  },
  {
    ...
    type: 'Guide',
    icon: 'Palette',
    href: '/downloads/brand-color-guide.txt',
    filename: 'Lisgraphix-Brand-Color-Guide.txt',
    tag: 'Free Download',
    pages: '4 pages',
  },
  {
    ...
    type: 'Guide',
    icon: 'TrendingUp',
    href: '/downloads/seo-quick-wins.txt',
    filename: 'Lisgraphix-SEO-Quick-Wins.txt',
    tag: 'Free Download',
    pages: '5 pages',
  },
  {
    ...
    type: 'Guide',
    icon: 'MessageCircle',
    href: '/downloads/whatsapp-business-guide.txt',
    filename: 'Lisgraphix-WhatsApp-Business-Guide.txt',
    tag: 'Free Download',
    pages: '6 pages',
  },
  {
    ...
    type: 'Template',
    icon: 'CalendarDays',
    href: '/downloads/social-media-calendar.txt',
    filename: 'Lisgraphix-30Day-Social-Media-Calendar.txt',
    tag: 'Free Download',
    pages: '10 pages',
  },
];
